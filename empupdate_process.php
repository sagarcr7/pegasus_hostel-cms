...
$q= "SELECT * FROM workers WHERE id = '$id'";
                ...
                <input type="hidden" name="id" value="<?php echo $id?>">
                 <table width="100%" border="0" cellspacing="1" cellpadding="0" class="addstdtable">
                   <tr>
                    ...
                    <tr>
                         <td>Job title</td>
                          <td width="40%"><input type="text" name="w_jobtitle" id="w_jobtitle" value="<?php echo $row['w_jobtitle'];?>"/></td>
                    </tr>
                    <tr>
                         <td>Start date</td>
                    ...
                    <tr>
                         <td>Sex</td>
                          <td><input type="radio" name="w_sex" id="w_sex" value="<?php echo $row['w_sex'];?>"/>M</td>
                          <td><input type="radio" name="w_sex" id="w_sex" value="<?php echo $row['w_sex'];?>"/>F</td>
                          <td><input type="radio" name="w_sex" id="w_sex" value="<?php echo $row['w_sex'];?>"/>O</td>
