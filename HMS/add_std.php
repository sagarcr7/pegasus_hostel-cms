               ...
               <legend style="color:#FFFFFF; letter-spacing:2px;padding-left:10px;"><h2>Add Students Here</h2>
                 ...
                 <table width="100%" border="0" cellspacing="2" cellpadding="1" class="addstdtable">
                   <tr>
                    ...
                    <tr>
                         <td>Admit Date</td>
                          <td width="40%"><input type="text" name="admitdate" id="admitdate"></td>
                    </tr>
                    <tr>
                         <td>Edu. Level</td>
                    ...
                    <tr>
                         <td>Sex</td>
                        <td><input type="radio" name="sex" id="sex" value="M" <?php if(isset($_POST['sex']) && $_POST['sex']=="M") { ?>checked<?php  } ?>> M
                        <input type="radio" name="sex" id="sex"  value="F" <?php if(isset($_POST['sex']) && $_POST['sex']=="F") { ?>checked<?php  } ?>> F
                        <input type="radio" name="sex" id="sex" value="O" <?php if(isset($_POST['sex']) && $_POST['sex']=="O") { ?>checked<?php  } ?>>O</td>
