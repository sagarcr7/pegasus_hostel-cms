	...
	<div class="content">
        ...
        <div class="box2">
          <fieldset style="width:auto;height:auto;">
               <legend style="color:#FFFFFF; letter-spacing:2px;padding-left:10px;"><h2>Add Salary records Here</h2>
               </legend>	
      			  <form method="post" action="addsalary_action.php" name="add_salary" id="add_salary">
                 <table width="100%" border="0" cellspacing="1" cellpadding="0" class="addstdtable">
                   <tr>
                        <td width="20%">Emp_id</td>
                        <td width="40%"><input type="text" name="emp_id" id="emp_id"></td>
                    </tr>
                    <tr>
                         <td>Paid Amount</td>
