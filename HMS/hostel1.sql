...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 22, 2017 at 08:49 AM
...
(1, 'ram', 'gurung', 'aas@gmail.com', 'F', '2000-02-15', 'manager', 5646682, '2015-01-25'),
...
--
ALTER TABLE `std_registration`
  MODIFY `std_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
